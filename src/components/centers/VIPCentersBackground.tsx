...
const VIPCentersBackground = ({ className = "" }: VIPCentersBackgroundProps) => {
  return (
    <div className={`absolute inset-0 z-0 overflow-hidden ${className}`}>
      ...
      <div className="absolute inset-0 bg-[linear-gradient(rgba(255,255,255,.008)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,.008)_1px,transparent_1px)] bg-[size:32px_32px] [mask-image:radial-gradient(ellipse_60%_60%_at_50%_50%,black_40%,transparent_100%)]" />
    </div>
  );
};
