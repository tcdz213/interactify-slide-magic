...
| ID | Page | Score | Tasks | Target |
|----|------|-------|-------|--------|
| 6.01 | Home `/m/sales` | 55% | Dynamic user name, today's visit plan, target progress, customer map mock, quick reorder, sales leaderboard | 95% |
| 6.02 | Create Order `/m/sales/orders/create` | 50% | Offline mock, barcode scanner mock, GPS check-in mock, price by segment, order confirmation, photo attachment, sync queue | 95% |
| 6.03 | Customers `/m/sales/customers` | 45% | Map view mock, check-in at location, add new customer, customer detail, order history, route planning, offline mock | 95% |
| 6.04 | Collections `/m/sales/collections` | 45% | Record payment, receipt generation mock, cheque photo mock, daily summary, sync with accounting, offline mock | 95% |
| 6.05 | Profile `/m/sales/profile` | 40% | Edit profile, sales targets display, commission tracking, notification prefs, language, logout, support | 95% |
...
|-------|--------|----------|------------|
| Phase 1 — Business Core | 🟡 In Progress | 3/14 | Products ✅, Orders ✅, OrderDetail ✅ |
| Phase 2 — Business Ops | ⬜ Not Started | 0/10 | — |
| Phase 3 — Business Tools | ⬜ Not Started | 0/5 | — |
| Phase 4 — Super Admin | ⬜ Not Started | 0/9 | — |
| Phase 5 — Mobile Driver | ⬜ Not Started | 0/5 | — |
| Phase 6 — Mobile Sales | ⬜ Not Started | 0/5 | — |
| Phase 7 — Landing + UX | ⬜ Not Started | 0/2 | — |
| Phase 8 — Polish & QA | ⬜ Not Started | 0/8 | — |
| **TOTAL** | **🟡 In Progress** | **3/58** | **3/49 pages** |
